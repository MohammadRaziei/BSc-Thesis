...
الگوریتم استفاده شده در این پروژه \gls{a:dqn} می‌باشد. مقدار $\gamma$ در این الگوریتم $0.8$ انتخاب شده است. یا توجه به \w{state} و  \w{reward} های تعریف شده در فصل \ref{ch:alg} پس از 400 بار تلاش به \w{optpol} می‌رسد.
