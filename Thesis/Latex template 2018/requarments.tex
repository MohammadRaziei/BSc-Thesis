...
\begin{note}
	...
	\begin{center}
		\LRE{\verb|_supported_versions = ['2.7', '3.4', '3.5', '3.6']|}
	\end{center}
\end{note}
...
\subsection{معرفی بسته \lr{gym}}
بسته 
\href{https://github.com/openai/gym}{\lr{gym}}
 که توسط 
 \href{https://github.com/openai}{\lr{OpenAI}}
 توسعه یافته است. این ابزار فوق العاده این امکان را برای محقیقین علوم کامپیوتر فراهم می‌کند که 
